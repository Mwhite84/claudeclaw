...
const DEFAULT_SETTINGS: Settings = {
  ...
  discord: { token: "", allowedUserIds: [], listenChannels: [], listenGuilds: [], allowedGuilds: [], imageOutputRoots: [], streaming: false, maxChannelSessions: 5, memoChannels: [], threadOnlyChannels: [] },
